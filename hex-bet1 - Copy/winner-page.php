<?php
include('slots/includes/common_includes.php');
include('slots/includes/slots.php');
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/style.css?ver=1.0.16" />
    <link rel="stylesheet" type="text/css" href="css/responsive.css" />
    <link rel="icon" href="images/favicon.png" type="image/gif" sizes="16x16">
    <!-- slot css  -->
    <link type="text/css" rel="stylesheet" href="slots/css/slots.css" />
    <link type="text/css" rel="stylesheet" href="slots/css/template5.css" />
...
<body>
       <?php
        ...
        echo '<h2>' . $gameType . '</h2>';
        include('slots/includes/slots_template.php');
    ?>
    <!-- Chat Box -->
        ...
        <div class="container">
            <div class="banner-inner-wrapper">
                <div class="banner-winner">
                    ...
                    <!--<img src="images/winner-img.png" alt="img"> -->
                        <!-- <div class="winner-block-inner" id="sm">
                            <div class="winner-block-inner-block ">
                                <div class="group">
                                    <div class="reel"></div>
                                </div>
...
.group {
  ...
  .reel {
    ...
    <script type="text/javascript" src="slots/js/jquery-ui-1.8.17.custom.min.js"></script>
    <script type="text/javascript" src="slots/js/soundmanager2.js"></script>
    <script type="text/javascript" src="slots/js/slots.js"></script>
</body>
</html>